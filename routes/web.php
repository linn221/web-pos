...
Route::get('/test', function () {
    ...
    $sql_product_count = DB::table('vouchers')
    ...
    ->joinSub($sql_product_count, 'product_count', 'products.id', '=', 'product_count.product_id')
    ->select(['products.id as product_id', 'product_count.sold_amount as sold_amount'])
    ->orderBy('sold_amount', 'desc')
    // ->dd();
    ->get();
    // dd($sql);
